...
import com.liferay.practical.model.CategoryClp;
import com.liferay.practical.model.OrdersClp;
...
public class ClpSerializer {
		...
		synchronized (ClpSerializer.class) {
			...
			try {
				...
				String portletPropsServletContextName = (String)getMethod.invoke(null,
						"OrderManagement-portlet-deployment-context");
			...
			if (Validator.isNull(_servletContextName)) {
				_servletContextName = "OrderManagement-portlet";
			}
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"com.liferay.practical.model.impl.CategoryImpl")) {
		...
		if (oldModelClassName.equals(
					"com.liferay.practical.model.impl.OrdersImpl")) {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("com.liferay.practical.NoSuchCategoryException")) {
			return new com.liferay.practical.NoSuchCategoryException();
		}

		if (className.equals("com.liferay.practical.NoSuchOrdersException")) {
			return new com.liferay.practical.NoSuchOrdersException();
		}
