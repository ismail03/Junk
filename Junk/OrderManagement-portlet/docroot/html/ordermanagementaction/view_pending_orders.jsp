...
<liferay-ui:search-container emptyResultsMessage="there-are-no-pending-orders"
...
List<Orders> ordersList=OrdersLocalServiceUtil.findBypendingorders(themeDisplay.getScopeGroupId(),WorkflowConstants.STATUS_PENDING);
