...
/**
 * Provides the local service interface for tops_user. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Ismail
 * @see tops_userLocalServiceUtil
...
public interface tops_userLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link tops_userLocalServiceUtil} to access the tops_user local service. Add custom service methods to {@link com.liferay.practicle.slayer.service.impl.tops_userLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
