 ...
 * @generated
 */
public class NotifParamLocalServiceClp implements NotifParamLocalService {
    ...
    public NotifParamLocalServiceClp(
        ...
        _methodName20 = "getParamName";

        _methodParameterTypes20 = new String[] { "java.util.Locale", "long" };

        _methodName21 = "getNotifParams";

        _methodParameterTypes21 = new String[] { "long" };

        _methodName22 = "getNotifParamNames";
    ...
    public com.stc.echannels.epayments.model.NotifParam addNotifParam(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(notifParam) });
        } catch (Throwable t) {
        ...
        return (com.stc.echannels.epayments.model.NotifParam) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stc.echannels.epayments.model.NotifParam createNotifParam(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { notifParamId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stc.echannels.epayments.model.NotifParam deleteNotifParam(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { notifParamId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stc.echannels.epayments.model.NotifParam fetchNotifParam(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { notifParamId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stc.echannels.epayments.model.NotifParam getNotifParam(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { notifParamId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stc.echannels.epayments.model.NotifParam> getNotifParams(
        ...
        return (java.util.List<com.stc.echannels.epayments.model.NotifParam>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stc.echannels.epayments.model.NotifParam addNotifParam(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    ...
                    ClpSerializer.translateInput(paramName),
    ...
    public java.util.List<com.stc.echannels.epayments.model.NotifParam> getNotifParams(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName21,
                    _methodParameterTypes21, new Object[] { serviceId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
