...
/**
 * Provides the local service utility for PaymentRule. This utility wraps
 * {@link com.stc.echannels.epayments.service.impl.PaymentRuleLocalServiceImpl} and is the
 ...
 * @generated
 */
public class PaymentRuleLocalServiceUtil {
    private static PaymentRuleLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.stc.echannels.epayments.service.impl.PaymentRuleLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.stc.echannels.epayments.model.PaymentRule addPaymentRule(
        com.stc.echannels.epayments.model.PaymentRule paymentRule)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().addPaymentRule(paymentRule);
    }
    ...
    */
    public static com.stc.echannels.epayments.model.PaymentRule createPaymentRule(
        com.stc.echannels.epayments.service.persistence.PaymentRulePK paymentRulePK) {
        return getService().createPaymentRule(paymentRulePK);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stc.echannels.epayments.model.PaymentRule deletePaymentRule(
        com.stc.echannels.epayments.service.persistence.PaymentRulePK paymentRulePK)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePaymentRule(paymentRulePK);
    }
    ...
    */
    public static com.stc.echannels.epayments.model.PaymentRule deletePaymentRule(
        com.stc.echannels.epayments.model.PaymentRule paymentRule)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().deletePaymentRule(paymentRule);
    }
    ...
    */
    ...
    public static com.stc.echannels.epayments.model.PaymentRule fetchPaymentRule(
        com.stc.echannels.epayments.service.persistence.PaymentRulePK paymentRulePK)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchPaymentRule(paymentRulePK);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stc.echannels.epayments.model.PaymentRule getPaymentRule(
        com.stc.echannels.epayments.service.persistence.PaymentRulePK paymentRulePK)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getPaymentRule(paymentRulePK);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stc.echannels.epayments.model.PaymentRule> getPaymentRules(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getPaymentRules(start, end);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static int getPaymentRulesCount()
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getPaymentRulesCount();
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stc.echannels.epayments.model.PaymentRule updatePaymentRule(
        com.stc.echannels.epayments.model.PaymentRule paymentRule)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updatePaymentRule(paymentRule);
    }
    ...
    */
    ...
    public static com.stc.echannels.epayments.model.PaymentRule fetchByRuleIdAndTransId(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchByRuleIdAndTransId(ruleId, transId);
    }
    ...
    public static java.lang.Long findCountActivePaymentRuleByServiceType(
        ...
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .findCountActivePaymentRuleByServiceType(serviceTypeId);
    }

    public static void updatePaymentRuleDefaultValue(java.lang.Long ruleId,
        java.lang.String transId, java.lang.String defaultValue,
        java.lang.String userId,
        com.liferay.portal.service.ServiceContext serviceContext)
        throws com.liferay.portal.kernel.exception.SystemException {
        getService()
            .updatePaymentRuleDefaultValue(ruleId, transId, defaultValue,
    ...
    public static PaymentRuleLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    PaymentRuleLocalService.class.getName());

            if (invokableLocalService instanceof PaymentRuleLocalService) {
                _service = (PaymentRuleLocalService) invokableLocalService;
            } else {
                _service = new PaymentRuleLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(PaymentRuleLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(PaymentRuleLocalService service) {
    }
}
