...
/**
 * Provides the local service interface for Service. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author ahmed_fadlus
 * @see ServiceLocalServiceUtil
 * @see com.stc.echannels.epayments.service.base.ServiceLocalServiceBaseImpl
 * @see com.stc.echannels.epayments.service.impl.ServiceLocalServiceImpl
 * @generated
 */
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface ServiceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ServiceLocalServiceUtil} to access the service local service. Add custom service methods to {@link com.stc.echannels.epayments.service.impl.ServiceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
