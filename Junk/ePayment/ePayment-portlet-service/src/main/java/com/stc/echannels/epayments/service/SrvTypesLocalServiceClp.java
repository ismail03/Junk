 ...
 * @generated
 */
public class SrvTypesLocalServiceClp implements SrvTypesLocalService {
    ...
    public SrvTypesLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public com.stc.echannels.epayments.model.SrvTypes addSrvTypes(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(srvTypes) });
        } catch (Throwable t) {
        ...
        return (com.stc.echannels.epayments.model.SrvTypes) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public com.stc.echannels.epayments.model.SrvTypes createSrvTypes(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { serviceTypeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stc.echannels.epayments.model.SrvTypes deleteSrvTypes(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { serviceTypeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stc.echannels.epayments.model.SrvTypes fetchSrvTypes(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { serviceTypeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public com.stc.echannels.epayments.model.SrvTypes getSrvTypes(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { serviceTypeId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<com.stc.echannels.epayments.model.SrvTypes> getSrvTypeses(
        ...
        return (java.util.List<com.stc.echannels.epayments.model.SrvTypes>) ClpSerializer.translateOutput(returnObj);
    }
