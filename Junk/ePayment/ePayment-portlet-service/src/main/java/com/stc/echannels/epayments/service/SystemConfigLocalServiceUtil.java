 ...
 * {@link com.stc.echannels.epayments.service.impl.SystemConfigLocalServiceImpl} and is the
 ...
 * @see com.stc.echannels.epayments.service.impl.SystemConfigLocalServiceImpl
 * @generated
 */
public class SystemConfigLocalServiceUtil {
    private static SystemConfigLocalService _service;

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.stc.echannels.epayments.service.impl.SystemConfigLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.stc.echannels.epayments.model.SystemConfig addSystemConfig(
    ...
    */
    public static com.stc.echannels.epayments.model.SystemConfig createSystemConfig(
        java.lang.String transId) {
        return getService().createSystemConfig(transId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stc.echannels.epayments.model.SystemConfig deleteSystemConfig(
        java.lang.String transId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteSystemConfig(transId);
    }
    ...
    */
    ...
    public static com.stc.echannels.epayments.model.SystemConfig fetchSystemConfig(
        java.lang.String transId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().fetchSystemConfig(transId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stc.echannels.epayments.model.SystemConfig getSystemConfig(
        java.lang.String transId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().getSystemConfig(transId);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stc.echannels.epayments.model.SystemConfig> getSystemConfigs(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stc.echannels.epayments.model.SystemConfig updateSystemConfig(
        com.stc.echannels.epayments.model.SystemConfig systemConfig)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static com.stc.echannels.epayments.model.SystemConfig addSystemConfig(
        ...
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .addSystemConfig(serviceId, bankId, config, serviceContext);
    }
    ...
    public static com.stc.echannels.epayments.model.SystemConfig updateSystemConfig(
        ...
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService()
                   .updateSystemConfig(transId, serviceId, bankId, config,
            serviceContext);
    }
    ...
    public static java.lang.String getColumns(
        ...
        long serviceId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getColumns(portletConfig, locale, serviceId);
    }

    public static java.lang.String getData(java.util.Locale locale,
        long serviceId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getData(locale, serviceId);
    }
    ...
    public static com.stc.echannels.epayments.model.SystemConfig deleteSystemConfig(
        ...
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return getService().deleteSystemConfig(transId, serviceContext);
    }

    public static java.util.List<com.stc.echannels.epayments.model.SystemConfig> getSystemConfigs(
        long serviceId)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().getSystemConfigs(serviceId);
    }

    public static void saveSystemConfigs(long serviceId,
        java.lang.String config,
        com.liferay.portal.service.ServiceContext serviceContext)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        getService().saveSystemConfigs(serviceId, config, serviceContext);
    }
    ...
    public static SystemConfigLocalService getService() {
        if (_service == null) {
            InvokableLocalService invokableLocalService = (InvokableLocalService) PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
                    SystemConfigLocalService.class.getName());

            if (invokableLocalService instanceof SystemConfigLocalService) {
                _service = (SystemConfigLocalService) invokableLocalService;
            } else {
                _service = new SystemConfigLocalServiceClp(invokableLocalService);
            }

            ReferenceRegistry.registerReference(SystemConfigLocalServiceUtil.class,
                "_service");
        }
     ...
     */
    public void setService(SystemConfigLocalService service) {
    }
}
