 ...
 * @generated
 */
public abstract class PaymentChannelActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public PaymentChannelActionableDynamicQuery() throws SystemException {
		setBaseLocalService(PaymentChannelLocalServiceUtil.getService());
		setClass(PaymentChannel.class);
