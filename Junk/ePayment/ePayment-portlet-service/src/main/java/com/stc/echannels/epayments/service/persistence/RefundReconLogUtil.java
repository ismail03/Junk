...
/**
 * The persistence utility for the refund recon log service. This utility wraps {@link RefundReconLogPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class RefundReconLogUtil {
    private static RefundReconLogPersistence _persistence;
     ...
     */
    public static void clearCache(RefundReconLog refundReconLog) {
        getPersistence().clearCache(refundReconLog);
    }
     ...
     */
    public static List<RefundReconLog> findWithDynamicQuery(
     ...
     */
    public static RefundReconLog update(RefundReconLog refundReconLog)
        throws SystemException {
        return getPersistence().update(refundReconLog);
    }
    ...
    public static RefundReconLog update(RefundReconLog refundReconLog,
        ...
        return getPersistence().update(refundReconLog, serviceContext);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(refundReconLog);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(refundReconLogs);
    }
    ...
    */
    public static com.stc.echannels.epayments.model.RefundReconLog create(
    ...
    */
    public static com.stc.echannels.epayments.model.RefundReconLog remove(
        java.lang.String batchId)
    ...
    public static com.stc.echannels.epayments.model.RefundReconLog updateImpl(
        com.stc.echannels.epayments.model.RefundReconLog refundReconLog)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(refundReconLog);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stc.echannels.epayments.model.RefundReconLog findByPrimaryKey(
        java.lang.String batchId)
        throws com.liferay.portal.kernel.exception.SystemException,
            com.stc.echannels.epayments.NoSuchRefundReconLogException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.stc.echannels.epayments.model.RefundReconLog fetchByPrimaryKey(
        java.lang.String batchId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.stc.echannels.epayments.model.RefundReconLog> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static RefundReconLogPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (RefundReconLogPersistence) PortletBeanLocatorUtil.locate(com.stc.echannels.epayments.service.ClpSerializer.getServletContextName(),
                    RefundReconLogPersistence.class.getName());

            ReferenceRegistry.registerReference(RefundReconLogUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(RefundReconLogPersistence persistence) {
    }
}
