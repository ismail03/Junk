 ...
 * @generated
 */
public class PaymentChannelSrvsMapServiceClpInvoker {
    private String _methodName188;
    private String[] _methodParameterTypes188;
    private String _methodName189;
    private String[] _methodParameterTypes189;

    public PaymentChannelSrvsMapServiceClpInvoker() {
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName188.equals(name) &&
            ...
            return PaymentChannelSrvsMapServiceUtil.getBeanIdentifier();
        }

        if (_methodName189.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes189, parameterTypes)) {
            PaymentChannelSrvsMapServiceUtil.setBeanIdentifier((java.lang.String) arguments[0]);
