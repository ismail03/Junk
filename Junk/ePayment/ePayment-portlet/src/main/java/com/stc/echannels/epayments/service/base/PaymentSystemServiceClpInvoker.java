 ...
 * @generated
 */
public class PaymentSystemServiceClpInvoker {
    private String _methodName188;
    private String[] _methodParameterTypes188;
    private String _methodName189;
    private String[] _methodParameterTypes189;

    public PaymentSystemServiceClpInvoker() {
    ...
    public Object invokeMethod(String name, String[] parameterTypes,
        ...
        if (_methodName188.equals(name) &&
            ...
            return PaymentSystemServiceUtil.getBeanIdentifier();
        }

        if (_methodName189.equals(name) &&
                Arrays.deepEquals(_methodParameterTypes189, parameterTypes)) {
            PaymentSystemServiceUtil.setBeanIdentifier((java.lang.String) arguments[0]);
